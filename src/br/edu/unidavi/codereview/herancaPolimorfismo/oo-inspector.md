...
## Inspeção
1 - class URLFirstClassLoader (Disponível em: https://github.com/roundrop/ermasterr/blob/master/src/org/insightech/er/util/URLFirstClassLoader.java)
1) Sim
2) Sim

2 - class BibiscoServlet (Disponível em: https://github.com/andreafeccomandi/bibisco/blob/master/bibisco/src/com/bibisco/servlet/BibiscoServlet.java)
1) Sim
2) Sim

3 - class ApplicationActionBarAdvisor (Disponível em: https://github.com/andreafeccomandi/bibisco/blob/master/bibisco/src/com/bibisco/rcp/ApplicationActionBarAdvisor.java)
1) Sim
2) Sim

4 - class ApplicationWorkbenchWindowAdvisor (Disponível em: https://github.com/andreafeccomandi/bibisco/blob/master/bibisco/src/com/bibisco/rcp/ApplicationWorkbenchWindowAdvisor.java)
1) Sim
2) Sim

5 - class JettyManager (Disponível em: https://github.com/andreafeccomandi/bibisco/blob/master/bibisco/src/com/bibisco/manager/JettyManager.java)<br>
1 - Não.
2 - Não
